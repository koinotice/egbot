...
var UDFCompatibleDatafeedBase = /** @class */ (function () {
    ...
    UDFCompatibleDatafeedBase.prototype.updateDatafeedURL = function (datafeedURL, quotesProvider, requester) {
        var _this = this;
        this._datafeedURL = datafeedURL;
        this._requester = requester;
        this._historyProvider = new HistoryProvider(datafeedURL, this._requester);
...
// WEBPACK FOOTER //
// ./src/lib/trading_view/datafeeds/udf/lib/udf-compatible-datafeed-base.js