...
var UDFCompatibleDatafeed = /** @class */ (function (_super) {
    ...
    UDFCompatibleDatafeed.prototype.updateDatafeedURL = function (datafeedURL) {
        var requester = new Requester();
        var quotesProvider = new QuotesProvider(datafeedURL, requester);
        _super.prototype.updateDatafeedURL.call(this, datafeedURL, quotesProvider, requester);
    };
...
// WEBPACK FOOTER //
// ./src/lib/trading_view/datafeeds/udf/lib/udf-compatible-datafeed.js